...
export default function Blog() {
  return (
    <Layout>
      <Seo title="Blog" />
      <div className="flex flex-wrap sm:flex-row flex-col mt-12">
        <h1 className="sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0">Space of Zeing's Blog</h1>
