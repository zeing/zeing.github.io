      ...
      <div className="flex h-full w-full flex-wrap max-w-screen-lg p-20">
        <div class="flex w-full bg-white shadow p-4 rounded">
          <div class="text-center mt-4">
            ...
            <p class="text-sm font-hairline text-gray-600 mt-1">Subtitle</p>
          </div>
          ...
          <div class="mt-6 flex justify-between text-center">
            <div>
              ...
              <p class="text-xs mt-2 text-gray-600 font-hairline">Posts</p>
            </div>
            <div>
              <p class="text-gray-700 font-bold">99k</p>
              <p class="text-xs mt-2 text-gray-600 font-hairline">Likes</p>
            </div>
            <div>
              <p class="text-gray-700 font-bold">530</p>
              <p class="text-xs mt-2 text-gray-700 font-hairline">Shares</p>
            </div>
          </div>
          <div class="mt-6">
